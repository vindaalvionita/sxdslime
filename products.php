...
<head>
  ...
  <title>SXDSlime's Products</title>
    ...
    <div class="container">
     ...
     <div class="row">
      ...
      <?php while($perproduk = $ambil->fetch_assoc()){ ?>
        <div class="col-md-3">
          <div class="thumbnail">
            <img src="variant/<?php echo $perproduk ['photo'];?>" alt="" style="width:200px">
            <div class="caption">
              <h5><?php echo $perproduk['variant'];?></h5>
              <h5><?php echo $perproduk['size'];?></h5>
              <h6>Rp.<?php echo number_format ($perproduk ['price']);?></h6>
              <a href="buy.php?id=<?php echo $perproduk ['product_id'];?>" class="btn btn-success">BUY</a>
              <a href="detail.php?id=<?php echo $perproduk['product_id'];?>" class="btn btn-primary">DETAIL</a>
            </div>
          </div>
        </div>
      <?php } ?>
